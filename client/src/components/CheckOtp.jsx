...
const CheckOtp = ({ registerdata, isopen, onclose }) => {
    ...
    const handleSubmit = async (otpValue = null) => {
        ...
        try {
            // Convert OTP array to string before sending
    ...
    const handleResendOtp = async () => {
        setIsResending(true);
        try {
            const res = await api.post("/auth/SendOtp", registerdata);
            setOtp(['', '', '', '', '', '']);
            setTimeLeft(600);
            setError('');
            if (inputRefs.current[0]) {
                        ...
                        <>
                            <div className="text-center mb-2">
                                ...
                                <p className="text-base-content text-opacity-70 mb-4">
                                    ...
                                    <span className="font-medium text-base-content">{registerdata?.email}</span>
                                </p>
                            </div>
